  ...
  return (
    <motion.div
      ...
      style={
        featured
          ? {
              background: 'linear-gradient(160deg, #1e1b30 0%, #161420 100%)',
              border: '1px solid rgba(108, 92, 231, 0.35)',
              boxShadow: '0 0 0 1px rgba(108,92,231,0.1), 0 12px 60px rgba(0,0,0,0.6), 0 0 80px rgba(108, 92, 231, 0.12)',
            }
          : {
    ...
    >
      ...
      {featured && (
        <div
          ...
          style={{ background: 'linear-gradient(90deg, transparent 0%, #6C5CE7 30%, #a29bfe 70%, transparent 100%)' }}
        />
      )}
      ...
      <div className="px-5 pb-5 flex-1 flex flex-col">
        {isAvailable && embedUrl ? (
          ...
          >
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="#6C5CE7">
      ...
      <div
        ...
        style={{
          background: featured
            ? 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(108,92,231,0.08) 0%, transparent 60%)'
